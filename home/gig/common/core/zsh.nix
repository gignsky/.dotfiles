  ...
  programs.zsh = {
    ...
    zplug = {
      ...
      plugins = [
        ...
        {
          name = "plugins/gitfast";
          tags = [ "from:oh-my-zsh" ];
        } # Plugin from oh-my-zsh
        {
          name = "plugins/git-flow-avh";
          tags = [ "from:oh-my-zsh" ];
        } # Plugin from oh-my-zsh NOT SURE WHAT GIT FLOW IS BUT KEEPING THIS HERE IN CASE I USE IT IN THE FUTURE
        {
