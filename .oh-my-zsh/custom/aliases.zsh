...
alias reactivate='deactivate; rdd .venv; python -m venv .venv; cd ..; cd tdarr-node-switcher; pip list; pipi pipdeptree; cd ..; cd tdarr-node-switcher; pipdeptree; pipupdate'
